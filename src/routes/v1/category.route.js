...
router
  ...
  .get(auth('getCategory'),validate(categoryValidation.getCategory), categoryController.getCategorys);
 ...
 *     description: Only admins can retrieve all categorys.
 *     tags: [Category]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of categorys
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 *     description: Logged in categorys can fetch only their own category information. Only admins can fetch other categorys.
 *     tags: [Category]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in categorys can only update their own information. Only admins can update other categorys.
 *     tags: [Category]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in categorys can delete only themselves. Only admins can delete other categorys.
 *     tags: [Category]
 *     security:
 *       - bearerAuth: []
 *     parameters:
